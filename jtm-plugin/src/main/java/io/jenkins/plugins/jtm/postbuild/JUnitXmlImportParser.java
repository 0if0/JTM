...
public final class JUnitXmlImportParser {
    ...
    public static final class ImportedCase {
        private final String caseKey; // stable mapping key (classname + name)
        private final String displayTitle; // "name" from junit testcase (keeps spaces/umlauts)
        private final String projectKey; // derived from nearest enclosing testsuite/@name
    ...
    public static final class ParseResult {
        ...
        private final String projectKey; // fallback: first testsuite/@name in the XML
