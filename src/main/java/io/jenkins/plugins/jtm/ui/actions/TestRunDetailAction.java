...
public final class TestRunDetailAction implements Action {
    ...
    /** Jelly-safe preformatted pass rate for the summary card. */
    public String getPassRateLabel() {
        return String.format(Locale.ROOT, "%.1f", currentRun().getPassRate());
    }
    ...
    /**
     * POST …/runs/{id}/export — download a self-contained HTML or PDF report
